 ...
 * expandidos, tempo de execução (em ms) e número de iterações — todos
...
public class EstatisticasUI extends JFrame {
    ...
    public EstatisticasUI(MotorGrafico motor) {
        ...
        if (dados.isEmpty()) {
            ...
            vazio.setBackground(UITheme.BG);
            JLabel aviso = new JLabel(
                    "Nao foi possivel obter as estatisticas do labirinto atual.",
                    SwingConstants.CENTER);
            aviso.setForeground(UITheme.TEXT_PRIMARY);
            aviso.setFont(UITheme.FONT_BASE);
